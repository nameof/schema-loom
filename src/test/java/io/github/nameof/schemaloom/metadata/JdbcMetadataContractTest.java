...
public class JdbcMetadataContractTest {
    @Test public void mapsSchemaCrawlerMetadataToStableDtos() throws Exception {
        ...
        statement.execute("CREATE TABLE app.orders (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, customer_id INT NOT NULL, name VARCHAR(100) DEFAULT 'new', CONSTRAINT fk_orders_customer FOREIGN KEY(customer_id) REFERENCES app.customers(id))");
